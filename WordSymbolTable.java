...
import akoshkarova.hw2.WordList.Node;
...
//		String elements="";
//		Node tempElNode=first;
//		if(tempElNode==null){
//			return elements;
//			}
//		elements="(" + tempElNode.word + "," + tempElNode.count + ")";
//		tempElNode=tempElNode.next;
//		while(tempElNode !=null) {
//			elements += "; " + "(" + tempElNode.word + "," + tempElNode.count + ")";
//			tempElNode=tempElNode.next;
//		}
        
//        else {
//        	elements = "(" + head.word + "," + head.count + ")";
//            head = head.next;
//            while(head!=null) {
//            	elements += "; " + "(" + head.word + "," + head.count + ")";
//                     head = head.next;
